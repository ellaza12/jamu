            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px">Data About</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card p-3" style="border-radius: 10px; min-height: 200px;">
                   <div class="card-header d-flex justify-content-between align-items-center mb-3">
                    <h3 class="card-title"><i class="fe fe-lock"></i> List Data About </h3>
                    <a href="/admin/about/add" class="btn btn-sm" style="background-color: #3cb815; color:white"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            <table class="table table-striped table-bordered data-table hover">
                ...
                <tbody>
                    <?php $no = 1; ?>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                            <a href="{{url('public/about')}}/{{$data->foto}}" target="_blank">
                                <img src="{{ url('public/about/' . $data->foto) }}" class="rounded" style="width: 50px; height: 50px; object-fit: cover; object-position: center;">
                            </a>
                            @endif
                        </td>
                    ...
                    <td class="text-center" width="15%">
                        <a href="/admin/about/edit/{{$data->id}}">
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <label class="form-control">{{$data->keterangan}}</label>
             </div>
             <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/about/delete/{{$data->id}}" style="text-decoration: none;">
