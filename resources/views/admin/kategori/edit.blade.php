            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px;">Edit Data Kategori</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card" style="border-radius: 10px;">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fe fe-user mr-2"></i> Data Kategori
                        </h3>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" required class="form-control"
                                            placeholder="Masukkan Keterangan nama ....." value="{{ $kategori->nama }}">
                                    </div>
                                </div>
                            </div>
