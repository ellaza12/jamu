            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px;">Tambah Data Profil</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card" style="border-radius: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <!-- Form Input -->
                        <form action="/admin/profil/create" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tulisan1" required class="form-control" placeholder="Masukkan Tulisan 1...">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tulisan2" required class="form-control" placeholder="Masukkan Tulisan 2...">
                                    </div>
                                </div>
