            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px">Data Artikel</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card p-3" style="border-radius: 10px; min-height: 200px;">
                   <div class="card-header d-flex justify-content-between align-items-center mb-3">
                    <h3 class="card-title"><i class="fe fe-lock"></i> List Data Artikel </h3>
                    <a href="/admin/artikel/add" class="btn btn-sm" style="background-color: #3cb815; color:white"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            <table class="table table-striped table-bordered data-table hover">
                <thead>
                    <tr>
                        <th class="text-center" width="5%">#</th>
                        <th class="text-center" width="20%">Background Foto</th>
                        <th class="text-center" width="20%">Nama</th>
                        <th class="text-center" width="20%">Link Artikel</th>
                     ...
                     <tr>
                        <td class="text-center">{{ $no++ }}</td>
                         <td class="text-center">
                            ...
                            @else
                            <a href="{{url('public/artikel')}}/{{$data->bg_foto}}" target="_blank">
                                <img src="{{ url('public/artikel/' . $data->bg_foto) }}" class="rounded" style="width: 50px; height: 50px; object-fit: cover; object-position: center;">
                            </a>
                            @endif
                        </td>
                            <td>{{ $data->nama }}</td>
                        <td>
                            <a href="{{ $data->link_artikel }}" target="_blank"> Lihat Artikel </a>
                        </td>
                    <td class="text-center" width="15%">
                        <a href="/admin/artikel/edit/{{$data->id}}">
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group">
               <label for="exampleInputUsername1">artikel</label>
               <label class="form-control">{{$data->nama}}</label>
             </div>
             <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/artikel/delete/{{$data->id}}" style="text-decoration: none;">
