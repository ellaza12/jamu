            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px;">Tambah Data Artikel</h4>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form action="/admin/artikel/create" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autofocus name="link_artikel" required class="form-control" placeholder="Masukkan Link artikel .....">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
