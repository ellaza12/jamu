            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <h4 class="page-title" style="font-size: 20px">Data Video</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card p-3" style="border-radius: 10px; min-height: 200px;">
                   <div class="card-header d-flex justify-content-between align-items-center mb-3">
                    <h3 class="card-title"><i class="fe fe-lock"></i> List Data Video </h3>
                    <a href="/admin/video/add" class="btn btn-sm" style="background-color: #3cb815; color:white"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            <table class="table table-striped table-bordered data-table hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" width="20%">Link Video</th>
                     ...
                     <tr>
                        <td class="text-center">{{ $no++ }}</td>
                         <td class="text-center">
                            ...
                            @else
                            <a href="{{url('public/video')}}/{{$data->bg_foto}}" target="_blank">
                                <img src="{{ url('public/video/' . $data->bg_foto) }}" class="rounded" style="width: 50px; height: 50px; object-fit: cover; object-position: center;">
                            </a>
                            @endif
                        </td>
                            <td>{{ $data->nama }}</td>
                        <td>
                            <a href="{{ $data->link_video }}" target="_blank"> Lihat di Youtube </a>
                        </td>
      ...
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="form-group">
             ...
             <div class="row mt-4">
               <div class="col-md-6">
                  <a href="/admin/video/delete/{{$data->id}}" style="text-decoration: none;">
