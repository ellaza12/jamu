            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                        <h1 class="display-5 mb-3">Detail Produk Jamu</h1>
                    </div>
                </div>
                ...
                <div class="align-items-stretch wow fadeInUp" data-wow-delay="0.1s">
                    <div class="product-item bg-light w-100 d-flex flex-row shadow-sm">
                        <div class="position-relative overflow-hidden" style="height: 300px;">
                            <img class="img-fluid w-100 h-100" src="{{ asset('public/produk/' . $produk->foto) }}" alt="{{ $produk->nama }}">
                        </div>
                        <div class="text-start p-4 flex-grow-1 d-flex flex-column">
                            <a class="d-block h5 mb-2">{{ $produk->nama }}</a>
                            <h6 class="text-primary fw-semibold mt-3">Kategori</h6>
                            <small class="text-muted d-block mb-2" style="text-align: justify;">
                                {{ $produk->nama_kategori ?? 'Kategori tidak ditemukan' }}
                            </small>
